...
^ What I lacked was both a pithy way to summarize
this, and the rhetorical grounding to land it.
Here's how I think this through now


---

# I needed a principle, and a mnemonic

"To build a memory ... it has to be a little bit weird"
- Per Sederberg (Ohio State University)


^Good mnemonics are weird, perhaps a little gross, or embarassing. 
...
* Worm Digestion: 
  * A simple system that work
  * Eats continually, liver produces bile continuously
* Human digestion:
  * A complex systems that works
  * Eats meals, liver stores bile in the Gall bladder
